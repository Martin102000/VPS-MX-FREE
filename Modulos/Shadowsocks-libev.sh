...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/Martin102000/VPS-MX-FREE/main/Install/ArchivosUtilitarios/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
