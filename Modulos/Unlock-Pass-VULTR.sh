...
wget https://raw.githubusercontent.com/Martin102000/VPS-MX-FREE/main/Install/ArchivosUtilitarios/common-password -O /etc/pam.d/common-password > /dev/null 2>&1
