...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/Martin102000/VPS-MX-FREE/main/Install/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
...
msg -bar
wget --no-check-certificate -O https://raw.githubusercontent.com/Martin102000/VPS-MX-FREE/main/Install/ArchivosUtilitarios/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
chmod +x Instalador-Shadowsocks-R.sh
